...
ActiveRecord::Schema.define(:version => 20101216093432) do
  ...
  create_table "archived_homework_scores", :force => true do |t|
    t.integer  "student_id"
  ...
  create_table "grouped_homeworks", :force => true do |t|
  ...
  create_table "homework_scores", :force => true do |t|
    t.integer  "student_id"
    t.integer  "homework_id"
    t.integer  "marks",            :limit => 10, :precision => 10, :scale => 0
    t.integer  "grading_level_id"
